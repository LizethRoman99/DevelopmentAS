...
namespace DevelopmentAS2.Controllers
{
    public class ProductoTerminadoesController : Controller
    {
        ...
        public ProductoTerminadoesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.ProductoTerminados.Include(p => p.IdFichaTecNavigation);
