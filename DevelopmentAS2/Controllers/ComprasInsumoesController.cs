...
namespace DevelopmentAS2.Controllers
{
    public class ComprasInsumoesController : Controller
    {
        ...
        public ComprasInsumoesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.ComprasInsumos.Include(c => c.IdComprasNavigation).Include(c => c.IdInsumoNavigation);
