...
namespace DevelopmentAS2.Controllers
{
    public class FichasTecInsumoesController : Controller
    {
        ...
        public FichasTecInsumoesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.FichasTecInsumos.Include(f => f.IdFichaNavigation).Include(f => f.IdInsumoNavigation);
