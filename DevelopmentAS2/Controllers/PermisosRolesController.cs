...
namespace DevelopmentAS2.Controllers
{
    public class PermisosRolesController : Controller
    {
        ...
        public PermisosRolesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.PermisosRoles.Include(p => p.IdPermisoNavigation).Include(p => p.IdRolNavigation);
