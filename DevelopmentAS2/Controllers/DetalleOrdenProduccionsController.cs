...
namespace DevelopmentAS2.Controllers
{
    public class DetalleOrdenProduccionsController : Controller
    {
        ...
        public DetalleOrdenProduccionsController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.DetalleOrdenProduccions.Include(d => d.NroOrdenProduccionNavigation);
