...
namespace DevelopmentAS2.Controllers
{
    public class FichasTecnicasController : Controller
    {
        ...
        public FichasTecnicasController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFicha,NombreFichaTecnica,EstadoFicha,Talla,Color")] FichasTecnica fichasTecnica)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFicha,NombreFichaTecnica,EstadoFicha,Talla,Color")] FichasTecnica fichasTecnica)
        {
