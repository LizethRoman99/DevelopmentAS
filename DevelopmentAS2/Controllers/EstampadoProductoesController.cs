...
namespace DevelopmentAS2.Controllers
{
    public class EstampadoProductoesController : Controller
    {
        ...
        public EstampadoProductoesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.EstampadoProductos.Include(e => e.IdCatalogoPNavigation);
