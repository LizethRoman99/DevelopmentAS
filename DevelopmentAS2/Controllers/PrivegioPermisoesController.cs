...
namespace DevelopmentAS2.Controllers
{
    public class PrivegioPermisoesController : Controller
    {
        ...
        public PrivegioPermisoesController(DevelopmentAs1Context context)
        {
            _context = context;
        }
        ...
        {
            var developmentAs1Context = _context.PrivegioPermisos.Include(p => p.IdPermisoNavigation).Include(p => p.IdPrivilegioNavigation);
