...
public partial class DevelopmentAs1Context : DbContext
{
    public DevelopmentAs1Context()
    {
    }

    public DevelopmentAs1Context(DbContextOptions<DevelopmentAs1Context> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CatalogoProducto>(entity =>
        {
            ...
            entity.Property(e => e.TamañoEstampado)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("tamañoEstampado");
        ...
        {
            entity.HasKey(e => e.IdDetalleOrdenProduccion).HasName("PK__DetalleO__47138A599A2DB8C7");
        ...
        {
            entity.HasKey(e => e.NroOrdenProduccion).HasName("PK__OrdenPro__E7D0CFDD5F23B05D");
